...
class ConnectionAwait {
     ...
     */
    awaitQuery(query, params): Promise<Query> {
        return new Promise((resolve, reject) => {
...
export class PoolAwait {
     ...
     */
    awaitGetConnection(): Promise<ConnectionAwait> {
...
const connection = new MysqlAwaitCustom();
